...
def kNearest(xyz1, xyz2, nsample):
    '''
    Input:
    ...
    return grouping_module.k_nearest(xyz1, xyz2,nsample)
ops.NoGradient('KNearest')
...
def knn_point(k, xyz1, xyz2):
    ...
    '''
    #val,idx=tf.nn.top_k(-tf.norm(tf.expand_dims(xyz1,1)-tf.expand_dims(xyz2,2),axis=-1),k=k)
    '''
    ...
    '''
    idx,val= grouping_module.k_nearest(xyz1, xyz2,k)
    return val, idx
...
if __name__=='__main__':
    ...
    with tf.device('/gpu:0'):
        ...
        if knn:
            ...
            #idx = kNearest(xyz1, xyz2, nsample)[0]
